...
public class PermanentTroubleCodesCommandTest {
    private PermanentTroubleCodesCommand command;
    ...
    public void setUp() throws Exception {
        command = new PermanentTroubleCodesCommand();
    }
    ...
    public void twoFramesWithFourDTC() throws IOException {
        mockIn = mockInputStreamRead("4A 00 03 51 04 A1 AB\n 4A F1 06 00 00 00 00>");
        String res = "P0003\n" +
                "C1104\n" +
                "B21AB\n" +
                "U3106\n";
    ...
    public void oneFrameWithThreeDTC() throws IOException {
        mockIn = mockInputStreamRead("4A 01 03 01 04 01 05>");
        String res = "P0103\n" +
                "P0104\n" +
                "P0105\n";
    ...
    public void oneFrameWithTwoDTC() throws IOException {
        mockIn = mockInputStreamRead("4A 01 03 01 04 00 00>");
        String res = "P0103\n" +
                "P0104\n";
    ...
    public void oneFrameWithTwoDTCCAN() throws IOException {
        mockIn = mockInputStreamRead("4A 02 01 20 01 21>");
        String res = "P0120\n" +
                "P0121\n";
    ...
    public void noData() throws IOException {
        mockIn = mockInputStreamRead("4A NO DATA>");
        command.readResult(mockIn);
    }
